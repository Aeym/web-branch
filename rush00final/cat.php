...
<div class="maxidiv">
  ...
  foreach($data as $type)
  {
    foreach ($type as $id)
    {
      if ($id['title'] && lookfor($id['genre'], $_GET['selected']))
      {
        if ($i = 1)
        {
          echo "<div class=\"num1\"><h2 class=\"blackfont\">".$id['title']."</h4><img height=450px src=".$id['url']." alt=".$id['title'].">";
          ...
          echo "<input type=\"text\" class=\"form-control\" id=\"quantity\" name=\"quantity\"size=1 required/>";
          echo "</div><br />";
        ...
        {
          echo "<div class=\"num2\"><h2 class=\"blackfont\">".$id['title']."</h4><img height=450px src=".$id['url']." alt=".$id['title']."></div>";
          echo "<p class=\"blackfont\">Public Price: <s>E24.99</s></p>";
          echo "<p class=\"blackfont\">Our Price: ".$id['price']." </p>";
          echo "<form action=\"add_cart.php\" method=\"POST\">";
          echo "<div class=\"col-xs-3\">";
        ...
        {
          echo "<div class=\"num3\"><h2 class=\"blackfont\">".$id['title']."</h4><img height=450px src=".$id['url']." alt=".$id['title']."></div>";
          echo "<p class=\"blackfont\">Public Price: <s>E24.99</s></p>";
          echo "<p class=\"blackfont\">Our Price: ".$id['price']." </p>";
          echo "<form action=\"add_cart.php\" method=\"POST\">";
          echo "<div class=\"col-xs-3\">";
